...
<head>
    ...
    <title>Fakturomat-Laravel Project</title>
    <!-- Favicon-->
...
<footer class="footer text-center">
    <div class="container">
        <div class="row">
            ...
            <!-- Footer Social Icons-->
            <div class="col-lg-4 mb-5 mb-lg-0">
                <h4 class="text-uppercase mb-4">ZNAJDŹ MNIĘ W SIECI</h4>
                <a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/daniel.jedrasiewicz"><i class="fab fa-fw fa-facebook-f"></i></a>
            ...
            <div class="col-lg-4">
                ...
                <p class="lead mb-0">
                    Fakturomat to projekt oparty o Laravela, umożliwiający wystawiaie faktur i dodawanie klientów.
                </p>
            </div>
        </div>
    </div>
...
<div class="copyright py-4 text-center text-white">
    <div class="container"><small>Copyright &copy; By Daniel Jędrasiewicz</small></div>
</div>
